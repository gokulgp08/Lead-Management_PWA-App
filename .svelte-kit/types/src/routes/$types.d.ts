...
type LayoutRouteId = RouteId | "/" | "/auth/login" | "/auth/register" | "/dashboard" | "/dashboard/leads/new" | "/dashboard/leads/[leadId]/delete" | "/dashboard/leads/[leadId]/edit" | null
type LayoutParams = RouteParams & { leadId?: string }
